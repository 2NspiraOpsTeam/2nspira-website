  ...
  return (
    <div className="flex flex-col h-full rounded-2xl bg-white p-8 shadow-sm dark:bg-zinc-950/50 border border-zinc-200 dark:border-zinc-800">
      <div className="flex-1">
        ...
        <h4 className="mt-6 text-base font-semibold text-zinc-900 dark:text-white">
          Key Insights:
        </h4>
      ...
      <div className="mt-6">
        <Link
          ...
          className="inline-flex w-full justify-center rounded-lg bg-orange-500 px-4 py-2 text-sm font-medium text-white hover:bg-orange-400 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-zinc-900"
        >
